...
@onready var content_container = $BG/Content
@onready var settings_page = $BG/Content/SettingsPage
...
func _on_hire_pressed():
	handle_tab_click($VBoxContainer/Hire, null)

func _on_upgrades_pressed():
	handle_tab_click($VBoxContainer/Upgrades, null)
