...
const QUOTES = {
	...
	"new_hire": [
		"BANTER_NEW_HIRE_01", "BANTER_NEW_HIRE_02", "BANTER_NEW_HIRE_03", "BANTER_NEW_HIRE_04", "BANTER_NEW_HIRE_05", "BANTER_NEW_HIRE_06", "BANTER_NEW_HIRE_07"
	],
	# [员工吐槽中心]:从等候区被拖动到工位上
	"seated": [
	...
	# [员工吐槽中心]:员工被拖去培训（区别于开会的开始/结束）
	"training_start": [
		"BANTER_TRAIN_START_1", "BANTER_TRAIN_START_2", "BANTER_TRAIN_START_3", "BANTER_TRAIN_START_4"
	]
}
